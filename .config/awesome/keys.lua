...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "space",     function () awful.spawn.with_shell("sh ~/.config/polybar/docky/scripts/launcher.sh") end,
              {description = "run rofi", group = "launcher"}),
    awful.key({ modkey },            "x",     function () awful.spawn.with_shell("sh ~/.config/polybar/docky/scripts/powermenu.sh") end,
              {description = "run rofi", group = "launcher"}),
